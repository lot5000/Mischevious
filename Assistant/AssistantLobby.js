...
//TODO: File taken from Spicey (Assistant/AssistantLobby.js)
//TODO: function startSession() were commented out, as well as references to it
//TODO: we will use sessions and structure from Mischevious
//TODO: currentassistantsetid.var, usedvirtualassistantdresses.var, lastassistantdresschange.var
//TODO: images for Assistant shall be put into /Images/Assistant
//TODO: no changes to the original file from Spicey (Assistant/Assistant.js) were made except this comment

{
    ...
    while (true) {
        if (answer.containsIgnoreCase("session", "domme")) {
            ...
            //sendVirtualAssistantMessage("Chores test");
			run("Structure/Modules/Chores/CleaningToilet.js");
			answer.clearOptions();
            answer.loop();
            ...
            answer.loop();
             ...
             //TODO: this gives "random is not defined error"
             //TODO: sendVirtualAssistantMessage(random("Bye", "Until next time", "See you", "I'm waiting for the next time", "Don't leave me alone to long", "Good bye", "Have a nice day", "I saved your process you can close the program"));
            sendVirtualAssistantMessage("Ending session with Mistress. You can close program now.");
            answer.clearOptions();
            endSession();
            break;
...
//        }
 ...
 //TODO: this gives "random is not defined error"
 //TODO: sendVirtualAssistantMessage(random("Launching", "Initiating", "Starting", "Establishing") + " session with Mistress");
sendVirtualAssistantMessage("Launching" + " session with Mistress");
